        ...
        <div class="logo-right">
            <table style="border-collapse:collapse;width:100%;">
                ...
                <tr>
                    ...
                    <td colspan="2"><strong>Date</strong> التاريخ &nbsp;&nbsp;&nbsp;<?php echo $lpodate; ?></td>

                </tr>
                <tr>
                    <td>
                        <strong>D.O. No.</strong> اذن تسليم رقم &nbsp;&nbsp;&nbsp; <?php echo $do; ?></td>


                    <td colspan="2"> Date االتاريخ &nbsp;&nbsp;&nbsp;<?php echo $dodate;
                        }
                        } ?> </td>
